...
import mx.itesm.exercises.LinkedListApplications;
...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * integerList.addFirst(7); integerList.addFirst(3); integerList.addLast(8);
		 * integerList.addLast(6); integerList.addLast(4); integerList.addLast(5);
		 * System.out.println(integerList);
		 * System.out.println(integerList.toStringReverse()); integerList.add(2, 29);
		 * System.out.println(integerList); integerList.set(2,9);
		 * System.out.println(integerList); integerList.removeFirst();
		 * System.out.println(integerList); integerList.removeLast();
		 * System.out.println(integerList); integerList.remove(2);
		 * System.out.println(integerList);
		 */
		LinkedListApplications a = new LinkedListApplications();
		System.out.println(a.isPalindrome("1111"));
		System.out.println(a.jumbleLetters("tank"));
		System.out.println(a.jumbleLetters("tlaxcala"));
		LinkedList<String> students = new LinkedList<String>();
		LinkedList<String> stringList = new LinkedList<String>("Peeta", "Gale", "Haymitch", "Primrose", "Effie");

		System.out.println(a.sortingHat(stringList, 7));
