...
class IntStackTest {
	...
	public void test1() {
		...
		assertEquals("Stack Overflow", assertThrows(IllegalStateException.class, () -> s.push(42)).getMessage());
	}
	...
	public void test2() {
		...
		assertEquals("Stack Underflow", assertThrows(NoSuchElementException.class, () -> s.pop()).getMessage());
		assertEquals("Stack Underflow", assertThrows(NoSuchElementException.class, () -> s.peek()).getMessage());
	}
